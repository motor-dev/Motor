...
context:chain_command(configure, "list_toolchains", "list_toolchains")
...
context:chain_command(setup, "vscode_cmake", "build")
context:chain_command(setup, "qtcreator", "build")
context:chain_command(setup, "qtcreator_qbs", "build")
