...
class Coff(_LoggerObject):
        ...
        for seckey in self.__symtables.keys():
            ...
            for sym in valuetble:
                ...
                while nidx < len(valuetble):
                    if valuetble[idx].storagecls != IMAGE_SYM_CLASS_LABEL and valuetble[
                        nidx].storagecls != IMAGE_SYM_CLASS_LABEL:
    ...
    def __parse_reloc(self, data):
        ...
        for section in self.sections:
            ...
            if section.offrel != 0 and (section.flags
                                        & IMAGE_SCN_CNT_CODE) != 0 and (section.flags & IMAGE_SCN_LNK_COMDAT) == 0:
