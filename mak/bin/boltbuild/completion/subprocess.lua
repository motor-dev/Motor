...
---@return boolean #A boolean indicating whether the process completed successfully (`true`) or encountered an error (`false`).
---@return ProcessOutput #The captured standard output of the process as `ProcessOutput` objects.
---@return ProcessOutput #The captured standard error of the process as `ProcessOutput` objects.
