...
@cxx98_merge
def ambiguous_decl_specifier_seq(self, continue_declaration_spec, end_declaration_spec):
...
@glrp.merge('decl-specifier')
@cxx98_merge
def ambiguous_decl_specifier_class(self, ambiguous_class_head_name, class_name):
    # type: (CxxParser, Optional[glrp.Production], Optional[glrp.Production]) -> None
    pass
