...
from ......ast.type import AbstractDeclaratorList, TypeIdDeclarator, DeclaratorElementArray, DeclaratorElementAbstract, DeclaratorElementError
...
@glrp.rule('new-expression : "::"? "new" "(" begin-type-id "#error" ")" new-initializer?')
@glrp.rule('new-expression : "::"? "new" new-placement "(" "#error" ")" new-initializer?')
@cxx98
...
@glrp.rule('noptr-new-declarator : "[" "#error" "]" attribute-specifier-seq?')
@cxx98
...
@glrp.rule('noptr-new-declarator : noptr-new-declarator "[" "#error" "]" attribute-specifier-seq?')
@cxx98
...
@glrp.rule('new-initializer? : "(" "#error" ")"')
@cxx98
