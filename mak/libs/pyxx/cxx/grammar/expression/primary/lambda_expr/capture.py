...
@cxx11
def lambda_capture_capture_default_cxx11(self, p):
...
@cxx11
def lambda_capture_capture_list_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx11
def lambda_capture_capture_default_list_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx11
def capture_default_reference_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@glrp.rule('capture-default : "="')
@cxx11
def capture_default_copy_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx11
def capture_list_end_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    return [p[0]]
...
@glrp.rule('simple-capture : "&" "identifier" "..."?')
@cxx11
def simple_capture_ref_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@glrp.rule('simple-capture :"*" "this"')
@cxx11
def this_capture_copy_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@glrp.rule('init-capture : "..." "identifier" initializer')
@cxx11
def init_capture_pack_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@glrp.rule('init-capture : "&" "identifier" initializer')
@cxx11
def init_capture_ref_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@glrp.rule('init-capture : "&" "..." "identifier" initializer')
@cxx11
def init_capture_ref_pack_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
