...
from ....ast.reference import Reference, Id, TemplateId
from motor_typing import TYPE_CHECKING


@glrp.rule('template-parameter : begin-type-parameter type-parameter')
@cxx98
def template_parameter_type(self, p):
...
@cxx98
def template_parameter_constant(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx98
def type_parameter_type(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx98
def type_parameter_type_default(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@cxx98
def type_parameter_template(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@cxx98
def type_parameter_template_default(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@glrp.rule('type-parameter : attribute-specifier-seq? type-parameter-key "..." "identifier"?')
@cxx11
def type_parameter_type_pack_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@glrp.rule('type-parameter : attribute-specifier-seq? template-head type-parameter-key "..." "identifier"?')
@cxx11
def type_parameter_template_pack_cxx11(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@cxx20
def type_parameter_constraint_cxx20(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@glrp.rule('type-parameter : attribute-specifier-seq? type-constraint "..." "identifier"?')
@cxx20
def type_parameter_constraint_pack_cxx20(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@cxx20
def type_parameter_constraint_default_cxx20(self, p):
    # type: (CxxParser, glrp.Production) -> Any
    # TODO: attribute-specifier-seq? not allowed
...
@cxx20
def type_constraint_identifier_cxx20(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx20
def type_constraint_template_name_cxx20(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx20
def type_constraint_nested_identifier_cxx20(self, p):
    # type: (CxxParser, glrp.Production) -> Any
...
@cxx20
def type_constraint_nested_template_id_cxx20(self, p):
    # type: (CxxParser, glrp.Production) -> Any
