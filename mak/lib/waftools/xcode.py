...
class XCodeScheme(XmlNode):
    ...
    def __init__(self, identifier: str, name: str, product: str, project: str, dummy: bool) -> None:
        ...
        if not dummy:
            ...
            self._add(scheme, 'ArchiveAction', {'buildConfiguration': 'final', 'revealArchiveInOrganizer': 'YES'})
