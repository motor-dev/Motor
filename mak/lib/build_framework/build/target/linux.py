...
def set_linux_rpath_program(task_gen: waflib.TaskGen.task_gen) -> None:
...
def set_linux_rpath_cxxshlib(task_gen: waflib.TaskGen.task_gen) -> None:
    if 'linux' in task_gen.env.VALID_PLATFORMS:
...
def setup_build_linux(_: BuildContext) -> None:
    pass
