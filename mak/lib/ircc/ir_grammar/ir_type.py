from ..ir_ast import IrTypeBuiltin, IrTypePtr, IrTypeVoid, IrTypeArray, IrTypeVector, IrTypeStruct, IrTypeReference, \
    IrTypeOpaque, IrTypeMethod, IrReference, IrTypeDeclaration
