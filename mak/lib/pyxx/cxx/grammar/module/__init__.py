...
@cxx20
def module_declaration_cxx20(self: CxxParser, p: glrp.Production) -> Any:
...
@cxx20
def module_declaration_export_cxx20(self: CxxParser, p: glrp.Production) -> Any:
...
@cxx20
def module_name_cxx20(self: CxxParser, p: glrp.Production) -> Any:
    return p[0] + [p[1].text()]
...
@glrp.rule('module-partition? : ":" module-name-qualifier? "identifier"')
@cxx20
def module_partition_cxx20(self: CxxParser, p: glrp.Production) -> Any:
    return p[1] + [p[2].text()]


@glrp.rule('module-partition? : ')
@cxx20
def module_partition_opt_cxx20(self: CxxParser, p: glrp.Production) -> Any:
    return None


@glrp.rule('module-name-qualifier? : ')
@cxx20
def module_name_qualifier_opt_cxx20(self: CxxParser, p: glrp.Production) -> Any:
    return []
