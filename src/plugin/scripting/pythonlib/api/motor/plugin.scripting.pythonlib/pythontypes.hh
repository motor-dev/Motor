...
typedef PyObject* (*Py_InitModule4Type)(const char* name, PyMethodDef* methods, const char* doc,
                                        PyObject* self, int apiver);
typedef PyObject* (*Py_InitModule4_64Type)(const char* name, PyMethodDef* methods, const char* doc,
                                           PyObject* self, int apiver);
...
typedef PyCodeObject* (*Py_CompileStringFlagsType)(const char* str, const char* filename, int start,
                                                   PyCompilerFlags* flags);
...
typedef int (*PyList_SetSliceType)(PyObject* list, Py_ssize_t low, Py_ssize_t high,
                                   PyObject* itemlist);
