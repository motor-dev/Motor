...
ref< IGPUResource >
Dx9Renderer::create(weak< const RenderWindowDescription > renderWindowDescription) const
{
    return ref< Dx9Window >::create(m_allocator, renderWindowDescription, this);
}

ref< IGPUResource >
Dx9Renderer::create(weak< const ShaderProgramDescription > shaderDescription) const
{
