...
void SymbolResolver::fillSymbol(Symbol& symbol, u64 address, const char* module,
...
ref< const SymbolResolver > SymbolResolver::loadSymbols(const SymbolInformations&   infos,
