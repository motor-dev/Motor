...
#ifndef MOTOR_RUNTIME_SYMBOLS_HH_
#define MOTOR_RUNTIME_SYMBOLS_HH_
/**************************************************************************************************/
...
class motor_api(RUNTIME) Symbol
{
...
class motor_api(RUNTIME) SymbolResolver : public minitl::refcountable
{
    MOTOR_NOCOPY(SymbolResolver);

private:
    ref< const SymbolResolver > m_next;

protected:
    static void  fillSymbol(Symbol & symbol, u64 address, const char* module, const char* filename,
...
public:
    ...
    static ref< const SymbolResolver > loadSymbols(const SymbolInformations&   infos,
                                                   ref< const SymbolResolver > next);
};
