...
#ifndef MOTOR_KERNEL_MSVC_X86_INTERLOCKED_INL
#define MOTOR_KERNEL_MSVC_X86_INTERLOCKED_INL
...
#    define MOTOR_HAS_INTERLOCKED64 0
#elif _MSC_VER >= 1400
#    include <intrin.h>
#    define MOTOR_HAS_INTERLOCKED64 1
#else
extern "C"
{
    // NOLINTBEGIN(bugprone-reserved-identifier)
