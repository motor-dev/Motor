...
motor_api(META) ConversionCost ConversionCalculator< u8 >::calculate(const Meta::Type& targetType)
{
...
motor_api(META) ConversionCost ConversionCalculator< i8 >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META) ConversionCost ConversionCalculator< u16 >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META) ConversionCost ConversionCalculator< i16 >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META) ConversionCost ConversionCalculator< u32 >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META) ConversionCost ConversionCalculator< i32 >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META) ConversionCost ConversionCalculator< u64 >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META) ConversionCost ConversionCalculator< i64 >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META) ConversionCost ConversionCalculator< bool >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META)
    ConversionCost ConversionCalculator< float >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
...
motor_api(META)
    ConversionCost ConversionCalculator< double >::calculate(const Meta::Type& targetType)
{
    if(targetType.metaclass->type() == ClassType_Number)
    {
        ConversionCost cost;
