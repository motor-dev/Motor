...
#ifndef MOTOR_META_FACTORIES_ARRAY_FACTORY_HH
#define MOTOR_META_FACTORIES_ARRAY_FACTORY_HH
...
struct ClassID< minitl::array< T, COUNT > >
{
...
template < typename T, u32 COUNT >
MOTOR_EXPORT raw< const Meta::Class > ClassID< minitl::array< T, COUNT > >::klass()
{
    static const Meta::Class s_class = {name(),
                                        u32(sizeof(minitl::array< T, COUNT >)),
                                        ...
                                        &metaCopy< minitl::array< T, COUNT > >,
                                        &metaDestroy< minitl::array< T, COUNT > >};
